      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Tambah costumer</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
      ...
      <div class="card-body">
        ...
        <form method="POST" action="/costumer">
            ...
            <div class="mb-3">
              ...
              <input type="text" name="nama_paket" class="form-control" id="exampleInputPassword1">
            </div>
            <div class="mb-3">
